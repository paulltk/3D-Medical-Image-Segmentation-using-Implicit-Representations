...
training_setups = [
               ("reconstruction", None, "golden", "1net", 30), 
               ("reconstruction", None, "golden", "2net", 30), 
               ("reconstruction", None, "golden", "4net", 30), 
               ("reconstruction", None, "golden", "golden", 30), 
               ("segmentation", "binary", "golden", "1net", 30), 
               ("segmentation", "binary", "golden", "2net", 30), 
               ("segmentation", "binary", "golden", "4net", 30), 
               ("segmentation", "binary", "golden", "golden", 30), 
               ]
